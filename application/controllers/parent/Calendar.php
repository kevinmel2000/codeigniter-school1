 ...
 * 
 */
class Calendar extends Parent_Controller {
    ...
    public function index() {
        ...
        $this->load->view("layout/parent/header.php");
        $this->load->view("parent/eventcalendar.php", $data);
        $this->load->view("layout/parent/footer.php");
    }

    public function getevents() {

        //print_r($this->session->userdata['admin']['username']);
        $userdata = $this->customlib->getLoggedInUserData();
