                            ...
                            <div class="padd2 paddtzero">
                                <table class="table2" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo $session_data['payment_detail']->amount; ?></td>
                                    </tr>
                                    <tr class="bordertoplightgray">
                                        <td colspan="2" class="text-right">Total: <?php echo $session_data['payment_detail']->amount; ?></td>
                                    </tr>
                                </table>
                                <?php
                                ...
                                <form class="paddtlrb" action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
                                    ...
                                    <input class="form-control" type="hidden" name="amount" value="<?php echo $session_data['payment_detail']->amount; ?>"  readonly/>
